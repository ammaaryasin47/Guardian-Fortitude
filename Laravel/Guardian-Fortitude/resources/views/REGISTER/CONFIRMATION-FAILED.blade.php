                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div style="letter-spacing: 2px;" class="card-body p-4 p-lg-5 text-black">
                                    <h1 class="text-center" style="font-size: 5rem;"><i class='bx bxs-user-x'></i></h1>
                                    <h1>THANK YOU FOR KEEPING PATIENCE</h1><br>
                                    <h1>YOU HAVE BEEN <br> <span style="color: maroon;">DENIED REGISTRATION</span></h1><br>
                                    <h1>FOR ANY QUERIES REGARDING SUCH CONTACT OUR TEAM<br><br> guardianfortitudeservices<br>@gmail.com</h1>
                                </div>
                            </div>
                        </div>
                    </div>
