...
<body>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div style="letter-spacing: 2px;" class="card-body p-4 p-lg-5 text-black">
                                    <h1>KINDLY WAIT FOR OUR TEAM TO <br> <span style="color: maroon;"> CONFIRM  YOUR
                                        REGISTRATION</span></h1>
                                        <br>
                                    <h1>SERVICES MAY RESUME AFTER CONFIRMATION</h1>
                                    <br>
  ...
  <x-footer />
    <script>
        // Redirect to confirmation success page after 3 seconds
        setTimeout(function() {
            window.location.href = "{{ route('register.confirmation.success') }}";
